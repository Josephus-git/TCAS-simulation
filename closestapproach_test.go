...
func TestFindClosestApproachDuringTransit(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			fp1: flightPath{
				depature: coord{X: 0, Y: 0, Z: 0},
				arrival:  coord{X: 10, Y: 0, Z: 0},
			},
			fp2: flightPath{
				depature: coord{X: 5, Y: -5, Z: 0},
				arrival:  coord{X: 5, Y: 5, Z: 0},
			},
		...
		},
		{
			...
			fp2: flightPath{
				depature: coord{X: 0, Y: 1, Z: 0},
				arrival:  coord{X: 10, Y: 1, Z: 0},
			},
		...
		},
		{
			...
			fp2: flightPath{
				depature: coord{X: 0, Y: 10, Z: 10},
				arrival:  coord{X: 10, Y: 10, Z: 0},
			},
		...
		},
		{
			...
			fp1: flightPath{
				depature: coord{X: 0, Y: 0, Z: 0},
				arrival:  coord{X: 1, Y: 0, Z: 0},
			},
			fp2: flightPath{
				depature: coord{X: 10, Y: 0, Z: 0},
				arrival:  coord{X: 11, Y: 0, Z: 0},
			},
		...
		},
		{
			...
			fp2: flightPath{
				depature: coord{X: 2, Y: 0, Z: 0},
				arrival:  coord{X: 8, Y: 0, Z: 0},
			},
		...
		},
		{
			...
			fp1: flightPath{
				depature: coord{X: 0, Y: 0, Z: 0},
				arrival:  coord{X: 5, Y: 0, Z: 0},
			},
			fp2: flightPath{
				depature: coord{X: 7, Y: 0, Z: 0},
				arrival:  coord{X: 10, Y: 0, Z: 0},
			},
			wantFp1: coord{X: 5, Y: 0, Z: 0},
		...
		},
		{
			...
			fp2: flightPath{
				depature: coord{X: 0, Y: 5, Z: 0},
				arrival:  coord{X: 0, Y: 10, Z: 0},
			},
			wantFp1: coord{X: 0, Y: 0, Z: 0},
...
func TestGetClosestApproachDetails(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			flight1: flight{
				flightSchedule: flightPath{depature: coord{0, 0, 0}, arrival: coord{100, 0, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
			flight2: flight{
				flightSchedule: flightPath{depature: coord{50, -50, 0}, arrival: coord{50, 50, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
		...
		},
		{
			...
			flight2: flight{
				flightSchedule: flightPath{depature: coord{0, 10, 0}, arrival: coord{100, 10, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
		...
		},
		{
			...
			flight2: flight{
				flightSchedule: flightPath{depature: coord{5, 0, 0}, arrival: coord{101, 0, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
		...
		},
		{
			...
			flight2: flight{
				flightSchedule: flightPath{depature: coord{-100, 0, 0}, arrival: coord{0, 0, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
			expectedClosestTime:             baseTime.Add(0 * time.Minute),
		...
		},
		{
			...
			flight2: flight{
				flightSchedule: flightPath{depature: coord{0, 100, 0}, arrival: coord{100, 100, 0}},
				takeoffTime:    baseTime,
				landingTime:    baseTime.Add(10 * time.Minute),
			},
